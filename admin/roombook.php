        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="review.php"><i class="fa fa-star"></i> Review</a>
                    </li>
                    <li>
...
<?php
						...
						{	
							...
							else if($st=="Not Conform"){
								rejected_email($email);
                                echo "<script type='text/javascript'> alert('Booking Rejection mail has been sent to user');
															window.location.href='home.php';
															</script>";
							}	
						}
...
function accepted_mail($email , $pid){
      ...
      try {
          ...
          $mail->Subject = 'E-mail conformation form Hotel Management System';
          $mail->Body    = "Your booking for hotel room has been accepted <br>
                             to download the reciept click <a href='http://localhost/hotel/admin/print.php?pid=$pid'>here</a>   ";
    ...
    function rejected_email($email){
        ...
        try {
            ...
            $mail->isHTML(true);                                  //Set email format to HTML
            $mail->Subject = 'E-mail Rejection form Hotel Management System';
            $mail->Body    = "Your booking for hotel room has been Rejected";
