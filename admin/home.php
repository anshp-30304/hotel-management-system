										...
										{		
											...
											echo"<div class='col-md-3 col-sm-12 col-xs-12'>
													<div class='panel panel-primary text-center no-boder bg-color-blue'>
														...
														<a href=show.php?sid=". $_SESSION['fid'] ."><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>
													Show
													</button></a>
                                                    
                                                    <a href=checkout.php?sid=". $_SESSION['fid'] ."><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>
													checkout
													</button></a><br>
															".$mrow['TRoom']."
														</div>
