...
<body>
 ...
 <div class="container">
      ...
      <div id="login">
        ...
        <form method="post">
          ...
          <fieldset class="clearfix">
            ...
            <p><input type="submit" name="sub"  value="Login"style="margin-bottom:23px;"></p>
      ...
      <div style="font-size: 23px;">  <h3><a href="../index.php">AHMEDABAD HOMEPAGE</a></h3></div>
    </div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id FROM login WHERE usname = '$myusername' and pass = '$mypassword' and u_type = 2";
